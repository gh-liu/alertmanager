...
The [Alertmanager](https://github.com/gh-liu/alertmanager) handles alerts
...
This can be configured using the [--cluster-*](https://github.com/gh-liu/alertmanager#high-availability) flags.
